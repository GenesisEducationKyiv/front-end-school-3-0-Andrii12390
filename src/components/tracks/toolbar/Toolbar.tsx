...
import { clearSelected, selectAllTracks, selectTracks } from '@/features/tracks/tracksSlice';
...
function Toolbar() {
  ...
  const { selectedIds: selectedTracks, isLoading } = useAppSelector(selectTracks);
